			...
			<div class="box-content">
				<form class="form-horizontal" id="form" method="post" >
					<div class="form-group has-feedback">
						<input type="hidden" class="form-control" id="id" name="id" value="${comCode.dictId}">
					...
					<div class="form-group  has-feedback">
						...
						<div class="col-sm-4">
							<input type="text" id="remark"  class="form-control" name="remark" value="${comCode.remark}">
						</div>
					</div>
					<div class="form-group  has-feedback">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="sort" name="sort" value="${comCode.sort}" 
								...
								ata-bv-regexp-message="必须为数字">
							<span class="fa fa-check-square-o txt-danger form-control-feedback"></span>
						</div>
						<label class="col-sm-1 control-label">状态</label>
						<div class="col-sm-4" id="del" style="padding-top: 3px">
