			...
			<div class="box-content">
				<form class="form-horizontal" id="form" name="form" >
					<div class="form-group has-feedback" >
						<label class="col-sm-1 control-label">保存路径:</label>
						<div class="col-sm-4">
						...
						<label class="col-sm-2 control-label" style="">数据库备份文件名:</label>
						<div class="col-sm-4">
							...
							<span style="display: block;margin-top: 5px;margin-left: -10px;float:left;">.dmp</span>
					</div>
					<div class="form-group " >
						<div class="col-sm-9"></div>
						<div class="col-sm-12 text-center">
							<button type="button" class="btn btn-default btn-xs btn-raycom" onclick="fncBackup()">保&nbsp;存</button>
						
							<button type="button" class="btn btn-default btn-xs btn-raycom" onclick="history.back(-1)">返&nbsp;回</button>
						</div>
					</div>
				</form>
			</div>
