							...
							<form class="form-horizontal" id="form" action="" method="post"
								...
								<div class="form-group has-feedback">
									<div class="col-sm-6">
										...
										<input type="hidden" class="form-control" value="${data.roleId}" disabled placeholder="角色编码" id="roleId" name="roleId" data-toggle="tooltip" data-placement="bottom">
										<div class="form-group has-feedback">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" id="roleName" name="roleName" value="${data.roleName}" placeholder="角色名称" data-toggle="tooltip" data-placement="bottom" 
													...
													data-bv-stringlength-message="该字段输入长度不能超过30"><span class="fa fa-check-square-o txt-danger form-control-feedback"></span>
											</div>
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												<%-- <input type="text" class="form-control" id="remarks" name="remarks" value="${data.remarks}" placeholder="备注"> --%>
												<textarea  class="form-control" placeholder="备注" id="remarks" name="remarks" style="width:500px;height:150px;resize:none" 
									...
									<div class="col-sm-6">
										<div class="form-group">
											<div class="ztreeBackground left" style="position:absolute; height:276px; width:90%; overflow:auto">
