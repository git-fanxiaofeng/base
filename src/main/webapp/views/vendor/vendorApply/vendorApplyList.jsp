...
<script type="text/javascript">
	...
	//进入详情
	function fncDetail(vendorApplyId){
		actSubmit($('#form'), ctx+"/vendorApply/vendorApplyDetail?vendorApplyId="+vendorApplyId);
	}
			...
			<div class="box-content">
				<form class="form-horizontal" id="form" method="post" action="/vendor/queryVendorList">
					<div class="form-group">
						...
						<div class="col-sm-2">
							<rt:select2 id="status" name="status"  dataQuery="yes" value="${status}" headerKey="-1" headerValue="全部" comCode="vendorStatus" ></rt:select2>
						</div>
						<div class="form-group " >							
				...
				<table class="table table-striped table-bordered " id="datatable-form" width="100%">
					<thead>
						<tr>
							...
							<th data-column="status">处理状态</th> 
							<th data-column="op" data-method="[
										{targets:-1,title:'详情',fncName:'fncDetail',params:'vendorApplyId'}
										]">操作</th>
						</tr>
					</thead>
					<tbody></tbody>
