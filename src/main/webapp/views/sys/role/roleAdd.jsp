								...
								<div class="form-group has-feedback">
									<div class="col-sm-6">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<textarea style="height:240px;resize:none" class="form-control" placeholder="备注" id="remarks" name="remarks"  
													data-bv-stringlength="true" 
									...
									<div class="col-sm-6">
										<div class="form-group">
											<div class="ztreeBackground left" style="position:absolute; height:294px; width:90%; overflow:auto">
